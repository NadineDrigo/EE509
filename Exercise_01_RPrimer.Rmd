...
1.	Evaluate the following:
   ...
   e.	-ln(5) -log(5)
   f.	ln(1/5) log(1/5)
g.	How does R represent when the output of a function is not a number? NaN
2.	Why are we multiplying the results of the atan and atan2 functions by 180/pi? because the functions take in radiants and we want the answer in degrees
3.	How is the atan2 function different from the atan function? atan takes one argument while atan2 takes 2 arguments
4.	What is the difference between log and log10? log is base e (ln) while log10 is base 10
...
d = d + r
y = y + 1
print(paste("The year is", y -1,"and the density is",d))
}
